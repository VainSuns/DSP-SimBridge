...
> **Historical archive notice:** 本文件属于已完成 SCI IoDevice V1.0 周期的历史实施计划，是当前 W5300 UDP 周期的直接前置历史计划；不再是当前 UDP implementation authority。当前规范入口为 `requirements/requirements_w5300_udp_iodevice_v1.0_frozen.md` 与根 `plan.md`；以下历史任务、Gate 与验证事实保持原义。
