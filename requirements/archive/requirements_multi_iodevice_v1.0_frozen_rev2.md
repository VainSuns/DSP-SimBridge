...
> **Historical archive notice:** 本文件属于已完成 V1.0 周期的冻结需求历史证据，不再是当前 UDP implementation authority。当前规范入口为 `requirements/requirements_w5300_udp_iodevice_v1.0_frozen.md` 与根 `plan.md`；以下历史正文、FR、Gate 与验证事实保持原义。
